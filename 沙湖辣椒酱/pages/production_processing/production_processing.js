...
Page({
  ...
  formSubmit: function (e) {
    var that = this
    var input_name = e.detail.value.seed_name
    ...
    var material_level = that.data.level[that.data.index3].num
    ...
    // }
    wx.request({
      url: getApp().globalData.url + '/api/basics/production_inputs_basic',
      method: 'POST',
      data: {
