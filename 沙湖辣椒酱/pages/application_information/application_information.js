...
Page({
  ...
  supplierValue() {
    let that = this;
    wx.request({
      url: getApp().globalData.url + '/api/purchase/drug' + '?purchase_batch=' + that.data.supplierName,
      method: 'GET',
      header: {
        'Content-Type': 'application/json',
        'X-Requested-With': 'XMLHttpRequest',
  ...
  supplierNull(val = '') {
    let that = this;
    wx.request({
      url: getApp().globalData.url + '/api/purchase/drug',
      method: 'GET',
      data: !val ? that.data.pageData : Object.assign(that.data.pageData, {
        page: parseInt(that.data.pageData.page) + 1
      }),
  ...
  bindKeyInput(e) {
    ...
    console.log(e.detail.value)
    wx.request({
      url: getApp().globalData.url + '/api/farming/base_info' + '?plant_batch=' + e.detail.value,
      method: 'GET',
      header: {
        'Content-Type': 'application/json',
        'X-Requested-With': 'XMLHttpRequest',
  ...
  bindKeyInput3(e) {
    ...
    console.log(e.detail.value)
    wx.request({
      url: getApp().globalData.url + '/api/purchase/drug' + '?purchase_batch=' + e.detail.value,
      method: 'GET',
      header: {
        'Content-Type': 'application/json',
        'X-Requested-With': 'XMLHttpRequest',
  ...
  formSubmit: function(e) {
    ...
    var perticide_time = that.data.date
    var disease_name = e.detail.value.disease_name
    var perticide_duration = e.detail.value.perticide_duration
    ...
    // }
    wx.request({
      url: getApp().globalData.url + '/api/farming/drug_info',
      method: 'POST',
      data: {
        plant_batch: plant_batch,
        inputs_batch: inputs_batch,
        inputs_amount: inputs_amount,
        perticide_time: perticide_time,
        disease_name: disease_name,
        perticide_duration: perticide_duration,
