...
Page({
  ...
  formSubmit: function (e) {
    ...
    var goods_code = e.detail.value.goods_code;
    var variety_id = that.data.goodsId;
    var working_code = e.detail.value.working_code;
    var specification = e.detail.value.specification;
    var unit = e.detail.value.unit;
    var gs1_code = e.detail.value.goods_bar;
    ...
    wx.request({
      url: getApp().globalData.url + '/api/basics/production_goods_basic',
      method: 'POST',
      data: {
