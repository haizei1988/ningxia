...
Page({
  ...
  formSubmit: function (e) {
    var that = this
    var pesticide_name = e.detail.value.seed_name
    ...
    var organic_pesticides = that.data.shifou[that.data.index2].num
    ...
    // }
    wx.request({
      url: getApp().globalData.url + '/api/basics/drug_basic',
      method: 'POST',
      data: {
