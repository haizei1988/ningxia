...
Page({
  ...
  goodsNameValue() {
    ...
    wx.request({
      url: getApp().globalData.url + '/api/basics/production_inputs_basic' + '?input_name=' + that.data.goodsName,
      method: 'GET',
      header: {
  ...
  bingId(event) {
    this.setData({
      ...
      goodsName: event.currentTarget.dataset.id.input_name,
      array_goods_status: true,
      hiddenLoading: true,
    })
  },
  ...
  bindKeyInput(e) {
    ...
    if (e.detail.value !== '') {
      wx.request({
        url: getApp().globalData.url + '/api/basics/production_inputs_basic' + '?input_name=' + e.detail.value,
        method: 'GET',
        header: {
          'Content-Type': 'application/json',
          'X-Requested-With': 'XMLHttpRequest',
  ...
  formSubmit: function (e) {
    var that = this
    var production_inputs_basic_id = that.data.goodsId;
    ...
    // }
    wx.request({
      url: getApp().globalData.url + '/api/purchase/pdt_inputs',
      method: 'POST',
      data: {
        production_inputs_basic_id: production_inputs_basic_id,
