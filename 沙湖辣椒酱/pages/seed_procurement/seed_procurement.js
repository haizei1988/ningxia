...
Page({
  ...
  goodsNameValue() {
    ...
    wx.request({
      url: getApp().globalData.url + '/api/basics/seed_basic' + '?seed_name=' + that.data.goodsName,
      method: 'GET',
      header: {
  ...
  bingId(event) {
    this.setData({
      ...
      goodsName: event.currentTarget.dataset.id.seed_name,
      array_goods_status: true,
      hiddenLoading: true,
    })
  },
  ...
  bindKeyInput(e) {
    ...
    if (e.detail.value !== '') {
      wx.request({
        url: getApp().globalData.url + '/api/basics/seed_basic' + '?seed_name=' + e.detail.value,
        method: 'GET',
        header: {
          'Content-Type': 'application/json',
          'X-Requested-With': 'XMLHttpRequest',
  ...
  formSubmit: function(e) {
    ...
    var sales_order_number = e.detail.value.purchase_quantity;
    ...
    wx.request({
      url: getApp().globalData.url + '/api/purchase/seed',
      method: 'POST',
      data: {
        seed_basic_id: seed_basic_id,
