...
Page({
  ...
  goodsNameValue() {
    ...
    wx.request({
      url: getApp().globalData.url + '/api/basics/inputs_basic' + '?inputs_name=' + that.data.goodsName,
      method: 'GET',
      header: {
        'Content-Type': 'application/json',
        'X-Requested-With': 'XMLHttpRequest',
  ...
  bindKeyInput(e) {
    ...
    if (e.detail.value !== '') {
      wx.request({
        url: getApp().globalData.url + '/api/basics/inputs_basic' + '?inputs_name=' + e.detail.value,
        method: 'GET',
        header: {
          'Content-Type': 'application/json',
          'X-Requested-With': 'XMLHttpRequest',
  ...
  formSubmit: function (e) {
    ...
    wx.request({
      url: getApp().globalData.url + '/api/purchase/inputs',
      method: 'POST',
      data: {
