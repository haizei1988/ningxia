...
Page({
  ...
  formSubmit: function (e) {
    var that = this
    var variety_name = e.detail.value.manufacturer_name;
    var variety_code = e.detail.value.manufacturer_code;
    var variety_brief = e.detail.value.variety_brief;
    var buy_url = e.detail.value.buy_url;
    var variety_images = that.data.imgs
    ...
    wx.request({
      ...
      data: {
        ...
        variety_brief: variety_brief,
        buy_url: buy_url,
        variety_images: variety_images,
      },
      header: {
